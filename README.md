...
External Accounts: A Groq API Key, a Cloudinary account, and a Gmail account with "App Passwords" enabled for SMTP.

Part 1: Backend Setup
Clone the backend repository:

Bash
git clone [https://github.com/Ruvinda-Shaluka/Examsy-Backend.git](https://github.com/Ruvinda-Shaluka/Examsy-Backend.git)
cd Examsy-Backend
Create the Database:
...
Clone the frontend repository (Open a new terminal window):

Bash
git clone [https://github.com/Ruvinda-Shaluka/Examsy-Frontend.git](https://github.com/Ruvinda-Shaluka/Examsy-Frontend.git)
cd Examsy-Frontend
